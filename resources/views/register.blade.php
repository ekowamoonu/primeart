...
<title>primeArt (Register) - Online Education For Artists</title>
@endsection

@section('main')
<div class="jumbotron index-jumbotron">
<div class="container-fluid form-container" id="register-container">
  <div class="row">
    <div class="col-md-4 mx-auto">
      <h5><i class="fa fa-user"></i> First, lets' create your primeArt account</h5>
      <div class="card">
        @if(count($errors)>0)
        ...
        <form action="/register-new-user" method="post">
          ...
          <input type="text" name="name" value="{{old('name')}}" class="form-control form-control-md">

          <label class="col-form-label mt-2 d-block">Email</label>
          ...
          <input type="tel" name="phone" id="phone_number" value="{{old('phone')}}" class="form-control form-control-md">

          <label class="col-form-label mt-2">Create a password <span class="badge badge-primary crosscheck">crosscheck</span></label>
          ...
          <input type="hidden" name="hidden_phone" id="hidden_phone">
            ...
            <!-- <label class="col-form-label mt-2">Email (optional)</label>
          <input type="text" class="form-control form-control-md"> -->
          <button type="submit" class="btn btn-block btn-teal mt-3">
           <i class="fa fa-thumbs-up"></i> Save and continue!</button>
           <p class="text-center mt-2"><a href="#" data-toggle="modal" data-target="#terms-modal">In signing up, you agree to our terms and conditions</a></p>
          <p class="text-center">Already have an account? <a href="{{URL::to('/')}}">Sign in here</a></p>
        </form>
      </div>
    </div>
  </div>
  ...
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle"><i class="fa fa-user"></i> Register and subscribe @ <!-- <span style="text-decoration: line-through;"><b>$47</b></span> --> <b>GH&#162;60.00 /mo.</b></h5><br>
      ...
      <div class="modal-body">
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-5">
               <img src="/images/register.png" class="img-fluid mt-3"/>
              </div>
              <div class="col-md-7">
                <p class="text-center mt-2">"I can't understand how anyone is able to be an artist without optimism. Despite the general pessimistic attitude in the world today, I am nothing but an optimist." ~Hans Hofmann</p>
              </div>
            </div><!--end row-->
            <div class="row">
              <div class="col-md-12">
                <p class="text-center mt-3 tagline">Refund available within 24hrs after subscription.</p>
              </div>
            </div>
          </div><!--end container fluid-->
             <div class="modal-footer">
              <button type="button" class="btn btn-dark close-modal" data-dismiss="modal">  Sign me up!
              </button>
             </div>
      </div><!--end modal body-->
...
<script type="text/javascript">
  $(function(){
      ...
      //alert($("#phone_number").intlTelInput("getNumber"));
  });
</script>
<script type="text/javascript">
  $(function(){
       ...
       $(".crosscheck").click(function(){
             ...
             if(field_type=="password"){
              ...
              $(".crosscheck").text("cover");
            }
             else{
              $("#password").attr("type","password");
              $(".crosscheck").text("crosscheck");
            }
       });
...
<script type="text/javascript">
  $(function(){
     $("#phone_number").keyup(function(){
         $("#hidden_phone").val($("#phone_number").intlTelInput("getNumber"));
     });
  });
</script>
<script type="text/javascript">
  $(function(){
      if($.cookie('regwelkies')==null){
               $("#welcome-modal").delay(1000).modal("show");
               $.cookie('regwelkies','1',{expires:100});
      }
  });
</script>
@endsection
